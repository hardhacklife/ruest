use crate::schema::{Attribute, FieldKind, Schema};

use super::naming::{column_name, default_sql, pg_type, table_columns, table_name};
...
fn generate_create_table(model: &crate::schema::Model) -> String {
